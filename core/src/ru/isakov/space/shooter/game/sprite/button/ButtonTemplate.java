...
public abstract class ButtonTemplate extends BaseButton {
    ...
    public ButtonTemplate(TextureAtlas atlas) {
        ...
        buttonElements.addAll(Arrays.asList(
                ...
                new ButtonElement(atlas, "Play", pos, 1.3f, 0, 0, 0f, 0, 0, new Color(1, 0.7f,0.7f, 1))
        ));
    }
    ...
    public void resize(Rect worldBounds) {
        ...
        for (ButtonElement buttonElement : buttonElements) {
            ...
            buttonElement.setLeft(worldBounds.getLeft() + PADDING);
